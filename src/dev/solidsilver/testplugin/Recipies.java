...
public class Recipies {
    ...
    public SmithingRecipe getChainmailRecipe() {
        ...
        SmithingRecipe chainmailRecipe = new SmithingRecipe(chainmailKey, chainmail,
                new RecipeChoice.MaterialChoice(Material.CHAIN), new RecipeChoice.MaterialChoice(Material.CHAIN));
    ...
    public ShapedRecipe getEmeraldPickRecipe() {
        ItemStack ePick = Items.getEmeraldPickaxe();

        NamespacedKey epKey = new NamespacedKey(this.plugin, "emerald_pickaxe");

        ShapedRecipe epRecipe = new ShapedRecipe(epKey, ePick);
        epRecipe.shape("EEE", " S ", " S ");
        epRecipe.setIngredient('E', Material.EMERALD);
        epRecipe.setIngredient('S', Material.STICK);
    ...
    public ShapedRecipe getObsidianPickRecipe() {
        ItemStack oPick = Items.getObsidianPickaxe();

        NamespacedKey opKey = new NamespacedKey(this.plugin, "obsidian_pickaxe");

        ShapedRecipe opRecipe = new ShapedRecipe(opKey, oPick);
        opRecipe.shape("OOO", " S ", " S ");
        opRecipe.setIngredient('O', Material.OBSIDIAN);
        opRecipe.setIngredient('S', Material.STICK);
    ...
    public FurnaceRecipe smeltGoldDust() {
        ...
        FurnaceRecipe gdRecipe = new FurnaceRecipe(nskey, gnugs, new RecipeChoice.ExactChoice(Items.getGoldDust()), 0f,
                20);
        return gdRecipe;
    }
    ...
    public FurnaceRecipe smeltIronDust() {
        ...
        FurnaceRecipe idRecipe = new FurnaceRecipe(nskey, inugs, new RecipeChoice.ExactChoice(Items.getIronDust()), 0f,
                20);
        return idRecipe;
    }
